								...
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<ul class="cs-user-accounts-list">
											<li class="active"><a href="user-car-listing.html">Vehicles</a></li>
									...
									<ul class="cs-featurelisted-car">
										<c:forEach items="${vehicles}" var="v">
											<li class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="cs-media">
													<figure><a href="viewvehicle?vehicleId=${v.vehicleId}"><img
																src="assets/extra-images/car-shortlisted-img1.jpg"
																alt="" /></a></figure>
												</div>
												<div class="cs-text">
						
													<h6><a href="viewvehicle?vehicleId=${v.vehicleId}">${v.brandName } ${v.vehicleName }</a></h6>
													<div class="post-options">
														<span><em>${v.modelYear}</em></span>
														<span><a href="#">${v.carType}</a></span>
													</div>
													<div class="cs-post-types">
														<div class="">
															<div class="cs-edit-post">
																...
																<a href="deletevehicle?vehicleId=${v.vehicleId}" ><i class="icon-trash-o"></i></a>
															</div>
